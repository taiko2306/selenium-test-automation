...
public class CorrectAction {
	private static int sheet_num = 12;
	...
	public static void execute(WebDriver driver) throws Exception {
		...
		try {
			...
			if(!condition.getText().equals("Received")) {
				...
				//output result
				Utility.setCellData("Claim is not approved!", row, col_result);
			}
			...
			//output result
			Utility.setCellData("Claim cannot be corrected", row, col_result);
