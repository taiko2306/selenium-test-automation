...
public class ApproveClaimAction {
	private static int sheet_num = 11;
	...
	public static void execute(WebDriver driver) throws Exception {
		...
		try {
			...
			if(condition.getText().equals("Reviewed")) {
				//enter claim
				...
				//output result
				Utility.setCellData("Claim is not reviewed!", row, col_result);
			}
			...
			//output result
			Utility.setCellData("Claim cannot be approved!", row, col_result);
